...
riot.tag2('content-service-instructor-course-add', '<model-themer> <fieldset> <label>Course name:<input name="course_name" type="text" placeholder="Wow. Such course."></label> <label>Course description:<textarea name="course_description" cols="40" rows="3" placeholder="Much course"></textarea></label> </fieldset> <button type="submit" name="add_course"> Add course! </button> </model-themer>', '', '', function(opts) {
	(function (self) {
	    self .on ('mount', function () {
